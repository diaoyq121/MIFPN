...
parser.add_argument('--resume', default="/home/diaoyueqin/dyq/M2FTrans_v1/output/model_last.pth", type=str)
...
def main():
    ...
    ##########setting models
    if args.dataname in ['BRATS2018','BRATS2020']:
        num_cls = 4
    else:
    ...
    if args.dataname == 'BRATS2020':
        train_file = '/home/diaoyueqin/diaoyueqin/BraTS/BRATS2020_Training_none_npy/train.txt'
        test_file = '/home/diaoyueqin/diaoyueqin/BraTS/BRATS2020_Training_none_npy/test.txt'
        ...
        train_file = '/home/z/文档/test/dyq/mmformer/file/train.txt'
        test_file = '/home/z/文档/test/dyq/mmformer/file/test.txt'
